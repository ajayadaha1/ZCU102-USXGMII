...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070100, 0x7F3F7F3FU ,0x0F102412U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG0_OFFSET, 0x7F3F7F3FU, 0x0F102412U);
/*##################################################################### */
...
unsigned long psu_mio_init_data(void)
{
    ...
    * lk- (Trace Port Clock)
    *  PSU_IOU_SLCR_MIO_PIN_0_L3_SEL                               5

    * Configures MIO Pin 0 peripheral interface mapping. S
    * (OFFSET, MASK, VALUE)      (0XFF180000, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_0_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
    ...
    * Signal)
    *  PSU_IOU_SLCR_MIO_PIN_1_L3_SEL                               5

    * Configures MIO Pin 1 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180004, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_1_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_2_L3_SEL                               5

    * Configures MIO Pin 2 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180008, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_2_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_3_L3_SEL                               5

    * Configures MIO Pin 3 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF18000C, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_3_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_4_L3_SEL                               5

    * Configures MIO Pin 4 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180010, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_4_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_5_L3_SEL                               5

    * Configures MIO Pin 5 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180014, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_5_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_6_L3_SEL                               5

    * Configures MIO Pin 6 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180018, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_6_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_7_L3_SEL                               5

    * Configures MIO Pin 7 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF18001C, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_7_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_MST_TRI0_PIN_00_TRI                        1
    ...
    *  PSU_IOU_SLCR_MIO_MST_TRI0_PIN_04_TRI                        1
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0x003FC0FFU ,0x00240055U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0x003FC0FFU, 0x00240055U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0x000FFF80U ,0x00003000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0x000FFF80U, 0x00003000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Each bit applies to a single IO. Bit 0 for MIO[0].
    *  PSU_IOU_SLCR_BANK0_CTRL3_SCHMITT_CMOS_N_BIT_0               1
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180140, 0x03FFFFFFU ,0x03E7FF55U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL3_OFFSET,
		0x03FFFFFFU, 0x03E7FF55U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18014C, 0x03FFFFFFU ,0x03DBFFAAU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03DBFFAAU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18015C, 0x03FFFFFFU ,0x01FDFFFFU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL3_OFFSET,
		0x03FFFFFFU, 0x01FDFFFFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x03F3FFFFU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03F3FFFFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180178, 0x03FFFFFFU ,0x03FFFFFFU)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180184, 0x03FFFFFFU ,0x03FFFFFFU)
    */
...
/*##################################################################### */
    ...
    /*
    * Register : Clock_Control_1 @ 0XFF120000

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC1_CLOCK_CONTROL_1_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF120000, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC1_CLOCK_CONTROL_1_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_2 @ 0XFF120004

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC1_CLOCK_CONTROL_2_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF120004, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC1_CLOCK_CONTROL_2_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_3 @ 0XFF120008

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC1_CLOCK_CONTROL_3_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF120008, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC1_CLOCK_CONTROL_3_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_1 @ 0XFF130000

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC2_CLOCK_CONTROL_1_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF130000, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC2_CLOCK_CONTROL_1_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_2 @ 0XFF130004

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC2_CLOCK_CONTROL_2_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF130004, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC2_CLOCK_CONTROL_2_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_3 @ 0XFF130008

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC2_CLOCK_CONTROL_3_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF130008, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC2_CLOCK_CONTROL_3_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_1 @ 0XFF140000

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC3_CLOCK_CONTROL_1_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF140000, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC3_CLOCK_CONTROL_1_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_2 @ 0XFF140004

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC3_CLOCK_CONTROL_2_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF140004, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC3_CLOCK_CONTROL_2_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_3 @ 0XFF140008

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC3_CLOCK_CONTROL_3_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF140008, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC3_CLOCK_CONTROL_3_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

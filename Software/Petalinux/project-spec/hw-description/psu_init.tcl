...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070100 0x7F3F7F3F 0x0F102412
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180000 0x000000FE 0x000000A0
    ...
    mask_write 0XFF180004 0x000000FE 0x000000A0
    ...
    mask_write 0XFF180008 0x000000FE 0x000000A0
    ...
    mask_write 0XFF18000C 0x000000FE 0x000000A0
    ...
    mask_write 0XFF180010 0x000000FE 0x000000A0
    ...
    mask_write 0XFF180014 0x000000FE 0x000000A0
    ...
    mask_write 0XFF180018 0x000000FE 0x000000A0
    ...
    mask_write 0XFF18001C 0x000000FE 0x000000A0
    ...
    mask_write 0XFF180204 0x003FC0FF 0x00240055
    ...
    mask_write 0XFF180208 0x000FFF80 0x00003000
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x03E7FF55
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x03DBFFAA
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FDFFFF
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03F3FFFF
    ...
    mask_write 0XFF180178 0x03FFFFFF 0x03FFFFFF
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x03FFFFFF
		# : LOOPBACK
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF260000 0x00000001 0x00000001
		# : TTC SRC SELECT
		# Register : Clock_Control_1 @ 0XFF110000</p>
    ...
    mask_write 0XFF110000 0x00000020 0x00000020
		# Register : Clock_Control_2 @ 0XFF110004</p>
    ...
    mask_write 0XFF110004 0x00000020 0x00000020
		# Register : Clock_Control_3 @ 0XFF110008</p>
    ...
    mask_write 0XFF110008 0x00000020 0x00000020
		# Register : Clock_Control_1 @ 0XFF120000</p>
    ...
    mask_write 0XFF120000 0x00000020 0x00000020
		# Register : Clock_Control_2 @ 0XFF120004</p>
    ...
    mask_write 0XFF120004 0x00000020 0x00000020
		# Register : Clock_Control_3 @ 0XFF120008</p>
    ...
    mask_write 0XFF120008 0x00000020 0x00000020
		# Register : Clock_Control_1 @ 0XFF130000</p>
    ...
    mask_write 0XFF130000 0x00000020 0x00000020
		# Register : Clock_Control_2 @ 0XFF130004</p>
    ...
    mask_write 0XFF130004 0x00000020 0x00000020
		# Register : Clock_Control_3 @ 0XFF130008</p>
    ...
    mask_write 0XFF130008 0x00000020 0x00000020
		# Register : Clock_Control_1 @ 0XFF140000</p>
    ...
    mask_write 0XFF140000 0x00000020 0x00000020
		# Register : Clock_Control_2 @ 0XFF140004</p>
    ...
    mask_write 0XFF140004 0x00000020 0x00000020
		# Register : Clock_Control_3 @ 0XFF140008</p>
    ...
    mask_write 0XFF140008 0x00000020 0x00000020
